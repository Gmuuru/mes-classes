...
public class RapportEleveController extends PageController implements Initializable {
    ...
    @FXML
    TitledPane absencesPane;
    @FXML
    VBox absencesBox;

    @FXML
    TitledPane retardsPane;
    @FXML
    VBox retardsBox;

    @FXML
    TitledPane travauxPane;
    @FXML
    VBox travauxBox;

    @FXML
    TitledPane devoirsPane;
    @FXML
    VBox devoirsBox;

    @FXML
    TitledPane punitionsPane;
    @FXML
    VBox punitionsBox;
    ...
    @FXML
    TitledPane oublisPane;
    @FXML
    VBox oublisBox;

    @FXML
    TitledPane exclusPane;
    @FXML
    VBox exclusBox;
    ...
    Button bulletinBtn;
    @FXML
    Pane vieScolairePane;
    @FXML
    Button vieScolaireBtn;
    @FXML
    ...
    private void handleDevoirPaneContent(List<Devoir> liste) {
        ...
        liste.forEach(d -> {
            devoirsBox.getChildren().add(buildLink(d.getSeance(), d.isClosed() ? " (non rendu)" : " (à ramasser)"));
        });
    }
    ...
    private void handlePunitionContent(List<Punition> liste) {
        ...
        liste.forEach(p -> {
            punitionsBox.getChildren().add(buildLink(
                    p.getSeance(), " : " + p.getTexte() + (p.isClosed() ? " (fermée)" : "")));
        });
    }
